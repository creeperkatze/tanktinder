...
// Desperation Meter
const averagePrice = computed(() => data.value?.averagePrice ?? null);
const desperationLevel = computed(() => data.value?.desperationLevel ?? 0);
...
<template>
    <div class="min-h-screen bg-[#0a0a0f] flex flex-col select-none">
        ...
        <header class="relative z-20 px-4 pt-4">
            <div class="max-w-sm mx-auto">
                ...
                >
                    ...
                    <p class="text-gray-600 text-xs text-center">von Creeperkatze</p>
        ...
        <!-- Card Stack -->
        <div class="relative flex flex-col items-center justify-start px-4 overflow-x-clip">
